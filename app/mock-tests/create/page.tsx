...
export default function CreateMockTestPage() {
  ...
  const handleCreateMockTest = async () => {
    try {
      ...
      const response = await api.post("/mock-tests", {
        course: courseId,
        name,
      ...
      setError(error.response?.data?.message || "Failed to create mock test. Please try again.")
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      <Header title="Create Mock Test" showBackButton />

      <main className="container mx-auto px-4 py-8">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-[#1f2937]">Create New Mock Test</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <Button className="bg-[#3b82f6] hover:bg-[#2563eb]" onClick={handleCreateMockTest} disabled={loading}>
